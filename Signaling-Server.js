...
module.exports = exports = function(app, socketCallback) {
    ...
    function onConnection(socket) {
        ...
        /*
         * swap between alarms and webrtc chat and video-chat
         */
        socket.on('request new post', function (msg) {
            io.sockets.emit('new post', msg);
            socket.broadcast.emit('new post', msg);
        });

        socket.on('request new member', function (msg) {
            io.sockets.emit('new member', msg);
